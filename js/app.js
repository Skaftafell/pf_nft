(() => {
    ...
    digitsCounter();
    (function() {
        const second = 1e3, minute = 60 * second, hour = 60 * minute, day = 24 * hour * 24;
        let today = new Date, dd = String(today.getDate()).padStart(2, "0"), mm = String(today.getMonth() + 1).padStart(2, "0"), yyyy = today.getFullYear(), nextYear = yyyy + 1, dayMonth = "02/09/", birthday = dayMonth + yyyy;
        today = mm + "/" + dd + "/" + yyyy;
